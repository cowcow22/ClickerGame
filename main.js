...
function updateAutoClick() {
  a = '<p> Auto-Clickers = ' + levelAutoClick + '</p>' + '<p> Cost : ' + hargaAutoClick + '</p>';
...
function updateCabang() {
  ...
  b = '<p> Cabang = ' + levelCabang + '</p>' + '<p> Cost : ' + hargaCabang + '</p>';
  cabang.innerHTML = b;
}
updateCabang();
// END LEVEL 0
...
var hargaJangkrikPremium = 20000;
